alter table data_owner add constraint codeUnique(code);
-- nieuwe shape inladen in gemeentetabel
-- nieuwe dataowner toevoegen aan dataowner tabel
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1945', 'Berg en Dal');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1930', 'Nissewaard');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1948', 'Meierijstad');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1954', 'Beekdaelen');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1959', 'Altena');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1960', 'West Betuwe');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1961', 'Vijfheerenlanden');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1978', 'Molenlanden');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1963', 'Hoeksche Waard');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1966', 'Het Hogeland');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1969', 'Westerkwartier');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1970', 'Noardeast-Fryslân');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1931', 'Krimpenerwaard');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1940', 'De Fryske Marren');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1942', 'Gooise Meren');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1950', 'Westerwolde');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1952', 'Midden-Groningen');
insert into data_owner (classificatie,code, omschrijving) values ('Infra Beheerder','CBSGM1949', 'Waadhoeke');
